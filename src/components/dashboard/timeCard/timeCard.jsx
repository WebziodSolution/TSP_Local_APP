...
const TimeCard = ({ handleSetTitle, setAlert }) => {
    ...
    const actionButtons = () => {
        return (
            <div className='grid grid-cols-2 gap-2 w-full md:flex md:flex-nowrap md:justify-end md:items-center md:w-auto'>
                        ...
                        {rows?.map((user) => (
                            <div key={user.id} className="mb-6 border p-4 rounded-lg shadow-sm">
                                <div className='flex flex-col md:flex-row justify-between items-start md:items-center mb-3 gap-2'>
                                    <div className='grow'>
                                        <h3 className="text-base md:text-lg font-semibold text-gray-700 capitalize text-start">{user.username} - {user.department}</h3>
                                    </div>
                                    <div>
                                        <p className="text-sm md:text-base font-medium text-gray-700 capitalize text-start md:text-end flex flex-wrap gap-x-4 gap-y-1">
                                            <span>Present: {user.presentCount || '0'}</span>
