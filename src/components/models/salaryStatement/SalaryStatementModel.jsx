                ...
                <form noValidate onSubmit={handleSubmit(submit)}>
                    <Components.DialogContent dividers>
                        {isInitialLoading ? (
                            ...
                            <>
                                <div className='flex flex-col sm:grid sm:grid-cols-6 mb-4 gap-2 sm:gap-4'>
                                    <div className='flex justify-start items-center gap-2 sm:col-span-2'>
                                        <p>Employee Name :</p>
                                ...
                                <div className='flex flex-col sm:flex-row justify-start items-start sm:items-center my-2 gap-2 sm:gap-5'>
